        ...
        <div>
            <NavBar />
             <div style={{ marginTop: '8rem', marginBottom: '5rem' }}>
                <h1 style={{ color: '#0B6000', textAlign: 'center' }}>Drought and Flood Monitoring Bulletins</h1>
            ...
            <Report title="DROUGHT FORECAST REPORT" seasonalForecast='Drought and Flood Monitoring Bulletins' />
            <Footer />
        </div>
    )
}
