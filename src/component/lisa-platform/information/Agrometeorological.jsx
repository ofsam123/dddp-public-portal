    ...
    return (
        <div>
            ...
            <div style={{ marginTop: '8rem', marginBottom: '5rem' }}>
                <h1 style={{ color: '#0B6000', textAlign: 'center' }}>Agrometeorological Bulletins</h1>
            ...
            <Report title="AGROMETOROLOGICAL FORECAST REPORT" seasonalForecast='Agrometeorological Bulletins' />
            <Footer />
        </div>
    )
}

export default Agrometeorological